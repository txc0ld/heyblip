...
struct BlipTextStyle: ViewModifier {
    ...
    func body(content: Content) -> some View {
        switch style {
        case .display:      content.font(theme.typography.display)
        case .largeTitle:   content.font(theme.typography.largeTitle)
        case .title2:       content.font(theme.typography.title2)
        case .headline:     content.font(theme.typography.headline)
        case .title3:       content.font(theme.typography.title3)
        case .body:         content.font(theme.typography.body)
        case .callout:      content.font(theme.typography.callout)
        case .subheadline:  content.font(theme.typography.subheadline)
        case .secondary:    content.font(theme.typography.secondary)
        case .footnote:     content.font(theme.typography.footnote)
        case .caption:      content.font(theme.typography.caption)
        case .captionSmall: content.font(theme.typography.captionSmall)
        }
    }
}
